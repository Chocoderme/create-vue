...
const featureFlags = ['typescript', 'jsx', 'router', 'pinia', 'vitest', 'cypress', 'auto-import', 'svg-loader', 'sass']
...
const withTestsFlags = fullCombination(['typescript', 'jsx', 'router', 'pinia', 'auto-import', 'svg-loader', 'sass']).map((args) => [
  ...args,
  'with-tests'
])

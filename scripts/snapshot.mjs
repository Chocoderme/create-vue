...
const featureFlags = ['typescript', 'jsx', 'router', 'pinia', 'vitest', 'cypress', 'auto-import', 'svg-loader', 'sass', 'element-plus']
...
const withTestsFlags = fullCombination(['typescript', 'jsx', 'router', 'pinia', 'auto-import', 'svg-loader', 'sass', 'element-plus']).map((args) => [
  ...args,
  'with-tests'
])
